        ...
        try:
            ...
            if _r.status_code == 200:
                ...
                if parse_v(_rv) > parse_v(_cfg.get("version", "1.0.0")):
                    ...
                    _url = "https://discord.gg/larpkido/archive/refs/heads/main.zip"
                    ...
                    print(Colorate.Horizontal(_cl["head"], "  [+] Update installed! Rebooting Larpkido Tool..."))
                    time.sleep(1.5)
...
def _nbot_ui():
    ...
    default_config = {
        "BOT_TOKEN": "",
        "MESSAGE_CONTENT": "@everyone | Server Nuked | discord: larpkido.tool | Larpkido Multitool",
        "WEBHOOK_URL": "This webhook for tracking your nukes",
        "GUILD_NEW_NAME": "larpkido owns this",
        "CHANNEL_AMOUNT": 60,
        ...
        "WEBHOOK_DELAY": 0.06,
        "SPAM_EMOJIS": ["🏴", "🌙", "🔥", "💀", "👾"],
        "WEBHOOK_USERNAME": "Larpkido Runs Cord",
        "COMMAND_PREFIX": "."
    }
    ...
    while True:
        ...
        cmd = get_inpt("larpkido@nukebot:~#").strip().lower()
...
def run_app():
    ...
    while 1:
        ...
        _c_raw = get_inpt(f"larpkido@root/{p_name}:~#").strip()
        _c = _c_raw.lower()
        ...
        if _c == "1":
            while 1:
                ...
                _cc = get_inpt("larpkido@discord/webhooks:~#")
            ...
            while 1:
                ...
                _cc = get_inpt("larpkido@discord/tokens:~#")
                if _cc == "1":
                    id_to_token()
