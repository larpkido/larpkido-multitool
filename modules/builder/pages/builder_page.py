...
class BuildThread(QThread):
    ...
    def run(self):
        try:
            ...
            if success:
                self.finished_signal.emit(True, "LARPKIDO: build completed")
            else:
                self.finished_signal.emit(False, "LARPKIDO: build failed")
                
        except Exception as e:
            self.log(f"\nLARPKIDO: error - {str(e)}")
            self.finished_signal.emit(False, f"LARPKIDO: build error")
...
class BuilderPage(QWidget):
    ...
    def start_build(self):
        ...
        if not filename:
            self.box = CustomMessageBox("LARPKIDO", "error", "LARPKIDO: enter file name")
            self.box.show()
            return
        ...
        self.build_window.add_log("LARPKIDO")
