...
class MainWindow(QMainWindow):
    ...
    def create_sidebar(self):
        ...
        footer = QLabel('<a href="https://discord.gg/larpkido" style="color: #888; text-decoration: none; font-size: 10px;">Larpkido Multitool</a>')
