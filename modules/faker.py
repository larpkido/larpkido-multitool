...
def fake_bruteforcer():
 ...
 |____/|_|  \_\\\\____/   |_|  |______|
    ...
    print(Colorate.Horizontal(cl["head"], f"  [!] INFO: {Colorate.Horizontal(cl['txt'], 'Larpkido Multitool - Advanced Simulation Engine.')}"))
    print("─" * 60)
